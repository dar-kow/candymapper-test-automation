export class HomePageComponents {
  ...
  phoneInput = 'input[data-aid="By entering a Phone Number you agree to our SMS Terms of Service"]';
  messageTextarea = 'textarea[data-aid="CONTACT_FORM_MESSAGE"]';
  submitButton = 'button[data-aid="CONTACT_SUBMIT_BUTTON_REND"]';
